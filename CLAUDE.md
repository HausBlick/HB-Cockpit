...
| 2 | **Seite 1 (Anschreiben)**: DIN-Adressfeld (Eigentümer-Postanschrift), personalisierte Anrede (Salutation), Ergebnis-Highlight-Box (nur Abrechnungsspitze — Nachzahlung/Guthaben mit olive/orange Farbkodierung), Schlusstext mit Verweis auf Beschlussfassung. Keine Kopfzeile/Trennlinie (wie Einzelwirtschaftsplan addFirstPage) |
