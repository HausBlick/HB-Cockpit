...
| Feature | Grund |
|---|---|
| PSD2/XS2A Bankschnittstelle | BaFin-Lizenz erforderlich — CSV-Import (6.4) reicht für die Zielgruppe |
| EBICS-Massenzahlungsverkehr | Unverhältnismäßig für Zielgruppe, Bankvertrag + Zertifikate nötig |
| Native iOS/Android-Apps | Web-App ist 100% responsiv — kein nativer App-Bedarf |
| Blockchain-Tokenisierung | Anderes Geschäftsmodell, kompletter Stack-Wechsel nötig |
| Messdienstleister-API (Techem/Ista) | Proprietärer ARGE-Standard, nur über Partnervertrag zugänglich |
